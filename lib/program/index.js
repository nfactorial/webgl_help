...
export default class Program {
    ...
    setAttributes(attributes) {
        ...
        for (let loop = 0; loop < count; loop++) {
            ...
            const location = this._gl.getAttribLocation(this.id, desc.name);
            if (location !== loop) {
                rebind = true;
                this._gl.bindAttribLocation(this.id, loop, desc.name);
            }
        ...
        this.attributeBuffer = createAttributeBuffer(attribArray);
    }
