...
export const InvalidProgram = null;
...
export default class Program {
    ...
    disable() {
        this._gl.useProgram(InvalidProgram);
    }
    ...
    getUniformLocation(name) {
        return this._id !== InvalidProgram ? this._gl.getUniformLocation(this._id, name) : null;
    }
}
