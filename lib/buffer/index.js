...
export default class BaseBuffer {
    ...
    /**
     * Reserve buffer memory of a specified length.
     * @param {number} length - The number of bytes to be reserved.
     * @returns {BaseBuffer} Reference to self, to allow for call chaining.
     */
    reserve(length) {
        if (!this._gl) {
        ...
        this._gl.bufferData(this._bufferType, length, this._drawType);
        return this;
    }

    /**
     * Creates an initializes the buffer objects data store.
     * @param data
     * @returns {BaseBuffer} Reference to self, to allow for call chaining.
     */
    bufferData(data) {
