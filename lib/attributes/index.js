 ...
 * @property {number} offset - Offset from the start of the vertex where the data begins.
 */
 ...
 */
export function createAttributeBuffer(gl, desc) {
    // TODO: Perhaps require a WebGL context, so we can resolve the parameters here.
    // TODO: See setAttributes in program/index.js
    ...
    const buffer = AttributeBuffer.fromDesc(gl, desc);
